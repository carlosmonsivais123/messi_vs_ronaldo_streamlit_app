...
from calculation_components.head_to_head_page_calcualations import HeadToHeadMatchupAnalytics
from general_components.sql_data_queries import SQLQueries

sql_queries=SQLQueries()
head_to_head_matchup_analytics=HeadToHeadMatchupAnalytics()
sidebar_filter_values=SidebarFilterValues()

# Page Title and Layout
st.set_page_config(page_title="Head to Head Matchups", layout="wide")
st.markdown("<h1 style='text-align: center;'>Head to Head Matchups</h1>", unsafe_allow_html=True)
